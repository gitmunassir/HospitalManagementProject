...
<head>
    ...
    <title>Dropdown - Health Care</title>
    ...
    <div class="page-container">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Change Password Here...</h4>
        ...
        <div class="container">
            <div class="login-box ptb--100">
                <form style="background:#dedede; opacity: 0.8;" Action="registrationcode.php" method="post">
                    <div class="login-form-head">
                        <h2>Change Your Password</h2>
                    </div>
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="exampleInputName1" style="color:black;" > Enter Old Password</label>
                            <input type="text" id="exampleInputName1"  name="oldpass" >
                            <i class="ti-key"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputEmail1" style="color:black;" >Enter New Password</label>
                            <input type="email" id="exampleInputEmail1" name="pass">
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputEmail1" style="color:black;" >Re-Write Password</label>
                            <input type="text" id="exampleInputEmail1" name="cpass">
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
                        </div>
