            ...
            <div class="login-box ptb--100">
                <form  action="contactcode.php"style="background:#dedede; opacity: 0.8; " method="post">
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="exampleInputName1" style="color:black;">Full Name</label>
                        ...
                        <div class="form-gp">
                            <label for="exampleInputPassword1" style="color:black;">Mobile No.</label>
                            <input type="text" id="exampleInputPassword1" name="mob">
