    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="opr.php"><h1><i class="fa fa-heartbeat hvr hvr-pulse"></i> Health Care</h1></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="patient.php" aria-expanded="true"><i class="ti-pie-chart"></i><span>Patient Details</span></a>
                              
                            </li>
                            <li class="">
                                <a href="fdetail.php" aria-expanded="true"><i class="ti-palette"></i><span>Fee Details</span></a>
                       
                            </li>
                            <li>
                                <a href="discusion.php" aria-expanded="true"><i class="ti-slice"></i><span>Discusion Board</span></a>
                               
                            </li>
                            <li>
                                <a href="logout.php" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>Logout</span></a>
        ...
        <div class="main-content">
           ...
           <center><h3 style=" color: antiquewhite; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; ">HEALTH CARE</h3></center></div>
               ...
               <div class="row">
                 ...
                 <div class="col-sm-1"><a href="opr.php"><i class="fa fa-home icon" style="color: rgb(81, 126, 111); font-size:50px;"></i></a></div>
            ...
            <div class="page-title-area">
                <div class="row align-items-center">
                 ...
                 <div class="user-profile pull-right">
                     <img class="avatar user-thumb" src="images/doc_ico.png" alt="avatar">
                     <h4 class="user-name dropdown-toggle" data-toggle="dropdown">'.$_SESSION['email'].' <i class="ti-angle-down"></i></h4>
                     <div class="dropdown-menu">
                     <a class="dropdown-item" href="viewdp.php"  data-target="#monis2" data-toggle="modal">View Profile</a>
               ...
               <div class="modal-content">
                      <div style="background: white;">
                           <div class="modal-body" style="align-item:centre;" >
                                <center> <h1 style="color:black;"><?php echo  $_SESSION['email'] ?></h1></center><hr>
                                
                               <center><img src="images/doc_ico.png" alt="" style="height:70px;width: 70px;"></center>
                            <?php
echo "<center><h1>In Future We Will Add Some New Feature In Profile View like your Photo Will Show Above And your detail will show here..</h1></center>"
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl ml-xl-3 mt-xl-0 mt-3">
                        <div class="stat-grid p-3 d-flex align-items-center justify-content-between " style="background-color: #FF5733;">
                            <div class="s-l">
                               <a href="pdetail.php"> <h5>Patient Details</h5></a>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between" style="background-color: #11505e;">
                            <div class="s-l">
                               <a href="fdetail.php"> <h5>Fee Details</h5></a>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between " style="background-color: #921c53;">
                            <div class="s-l">
                                <a href="emanagement.php"><h5>Enquiry Management</h5></a>
                    ...
                    <div class="outer-w3-agile col-xl ml-xl-3 mt-xl-0 mt-3">
                        <div class="stat-grid p-3 d-flex align-items-center justify-content-between " style="background-color: #FF5733;">
                            <div class="s-l">
                              <a href="Appointment.php">  <h5>Appoinment</h5></a>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between" style="background-color: #11505e;">
                            <div class="s-l">
                              <a href="mstore.php">  <h5>Medical Stores</h5></a>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between" style="background-color: #6B3A6C;">
                            <div class="s-l">
                                <a href="noti.php"><h5>Notifications</h5></a>
		...
		<div class="container ">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
					...
					<p class="h3" style="color:white;">© All right Reversed.<a class="text-green ml-2" href="https://www.mecatredztechnology.com" target="_blank">mecatredz Technology</a></p>
				</div>
				<hr>
			</div>	
		</div>
