...
<div class="col-sm-12">
                ...
                if($con==true)
                {
                    ...
                    if (mysqli_num_rows($x) > 0) {
                        ...
                        echo "<tr><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["mob"]."</td><td>".$row["dt"]."</td><td><a href='del.php?d=".$row["mob"]."' title='click here to delete'><span class='fa fa-trash' style='color:red;font-size:25px;'></span></a></td></tr>";
                        }
                      } else {
