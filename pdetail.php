...
<!--profile info & task notification -->
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Patient Detail</h4>
            ...
            <div class="row">
<div class="col-sm-12">
                  <table class="table table-responsiv" width="100%">
                      <tr>
                          <th>Name</th>
                          <th>Email Address</th>
                          <th>Date of Birth</th>
                ...
                if($con==true)
                {
                    ...
                    $x=mysqli_query($con,$x);
                    if (mysqli_num_rows($x) > 0) {
                        // output data of each row
                        while($row = mysqli_fetch_assoc($x)) {
                        echo "<tr><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["dob"]."</td><td>".$row["pass"]."</td><td><a href='regdel.php?d=".$row["email"]."' title='click here to delete'><span class='fa fa-trash' style='color:red;font-size:25px;'></span></a></td></tr>";
                        }
                      } else {
