...
<head>
    ...
    <title>Review - Health Care</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="opr.css">
    <link rel="stylesheet" href="footer.css">
    <link rel="shortcut icon" type="image/png" href="slider2.jpg">
...
<body data-aos="zoom-in">
  ...
  <div class="col-sm-3"><center><img src="images/digitalindia.png" alt="" class="img img-responsive hvr hvr-pop"></center></div>
     ...
     <nav class="navbar navbar-inverse">
        ...
        <i style="margin-top: 6px;" class="btn btn-danger glyphicon glyphicon-log-in" data-target="#monis" data-toggle="modal"></i></li>
    ...
    <div class="login-area login-s2" >
        <div class="container">
            <div class="login-box ptb--100">
                <form  action="contactcode.php"style="background:#dedede; opacity: 0.8; " method="post">
                    <div class="login-form-head">
                        <h4 style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Review Us</h4>
                        <p style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif ;">We will reply you soon....</p>
                    </div>
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            <label for="exampleInputPassword1" style="color:black;">Comment Plese...</label>
                            <input type="text" id="exampleInputPassword1" name="text">
                            <i class="fa fa-comment" ></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                          <label for="">  <i class="fa fa-star"></i></label>
                        </div>
                        <!-- <div class="form-gp">
                            <label for="exampleInputPassword2" style="color:black;"></label>
                           <textarea name="textarea" id="" cols="30" rows="10" placeholder="Give Message...."></textarea> 
